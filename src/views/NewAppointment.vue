  ...
  data() {
    return {
      ...
      state: {
        ...
        height: "",
        mensesDate: "",
        anameses: "Menses с [] лет по [] дней через [] дней, регулярные, безболезненные, умеренные. Половая жизнь с [] лет.\n" +
            "Полип эндометрия, [] - г/скопия, раздельное диагностическое выскабливание. Эрозия шейки матки, лазерная вапоризация в [] г.\n" +
            "Беременности:\nI.",
        analyzes_1: [],
        analyzes_2: [],
        analyzes_3: [],
        ...
        pregnancy: "На учете в ЖК с [] недель. ОПВ +[] кг.\n" +
            "Динамика АД: []/[] – []/[] – []/[] мм.рт.ст.\n" +
            "Анализ мочи – без патологических изменений.\n",
        hospital: "",
        research: "Общее состояние удовлетворительное.\n" +
            "Пульс – [] уд/мин, АД – []/[] мм рт. ст. на обеих руках, ЧД – [] в мин.\n" +
            "Рост – [] см, Вес тела – [] кг ([] кг – до беременности). Телосложение правильное.\n" +
            ...
            "Сердцебиение плода ясное, ритмичное, [] уд/мин.\n" +
